...
fun LoginView(onNavigateToHome: () -> Unit, onNavigateToSignUp: () -> Unit) {
    ...
    Column(
        ...
        OutlinedTextField(value = email, label = { Text("Enter your email or phone number.") }, shape = RoundedCornerShape(12.dp), colors = POutLinedTextFieldColors(), modifier = textFieldModifier, onValueChange = { text ->
            email = text
        })
